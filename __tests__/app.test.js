...
describe('refactory routes', () => {
  ...
  it('should be able to create a creature', async () => {
    ...
    expect(res).toEqual({ id: expect.any(String), title:'Falcore', species:'Dogon', lifespan:'not long enough', environment:'the-sky', img_url:'https://static.wikia.nocookie.net/theneverendingstory/images/8/8a/Falkor-neverending-story-96.2.jpg/revision/latest?cb=20190524234115' });
  });
  ...
  it('should be able to list creatures', async () => {
    await Creature.insert({  title:'Falcore', species:'Dogon', lifespan:'not long enough', environment:'the-sky', img_url:'https://static.wikia.nocookie.net/theneverendingstory/images/8/8a/Falkor-neverending-story-96.2.jpg/revision/latest?cb=20190524234115' });
    const res = await request(app).get('/api/v1/creatures');

    expect(res.body).toEqual([
      {
        id: expect.any(String),
        title:'Falcore', species:'Dogon', lifespan:'not long enough', environment:'the-sky', img_url:'https://static.wikia.nocookie.net/theneverendingstory/images/8/8a/Falkor-neverending-story-96.2.jpg/revision/latest?cb=20190524234115' },
    ]);
  });
